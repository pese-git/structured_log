...
/// The single source of truth for [LogLevel] indicator colors across every
...
///
/// Lives here rather than in any one skin package because [Color] and
/// [Brightness] (from `dart:ui`) aren't tied to Material, Cupertino, or
/// Fluent — this table is genuinely design-system-neutral, unlike the
/// widgets built on top of it.
///
/// Chosen to read clearly on both light and dark surfaces: each level keeps
/// the same hue between themes, tuned lighter for [Brightness.dark] so it
