...
![CupertinoLogViewer в боковой панели с flex 2:1 рядом с placeholder-контентом приложения — тот же список логов и панель деталей](doc/screenshots/embedded.png)
