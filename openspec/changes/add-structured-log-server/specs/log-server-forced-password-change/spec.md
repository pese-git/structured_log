...
#### Scenario: create-admin не помечает пароль временным
- **WHEN** администратор создан командой `create-admin` с паролем, который оператор указал сам
