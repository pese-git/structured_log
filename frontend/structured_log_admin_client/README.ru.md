...
проекты с их секретными ключами, просмотрщик логов, аудит.
...
настройки аккаунта, экран аудита.

Нет: пользователей, команд, выдачи ролей, восстановления пароля и подтверждения
email. За ними у сервера пока нет эндпоинтов, а пункт меню, открывающий пустой
экран, хуже непредложенного — что именно сделано, видно в
